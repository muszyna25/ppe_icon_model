!****************************************************************************
!                Time-stamp: <2013-08-16 09:19:40 kern_ba>
!****************************************************************************
...
MODULE messy_main_constants_mem
  ...
  CHARACTER(LEN=*), PARAMETER :: modver = '2.42'

  ! DISTRIBUTION MODIFICATION (please do NOT modify the next line!)
  ! OPTIONS: d2.42 -r -2 -k2 -o -c -s onlem -s offlem -s drydep -s radjimt -i main_gridtrafo
