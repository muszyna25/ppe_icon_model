...
the \texttt{include\_last} flag is set to \texttt{.FALSE.}, and
...
\texttt{total\_index}      \>  If namelist is split into concurrent files: substituted by the file index, \\ 
                           \>  which an "unsplit" namelist would have produced
\end{tabbing}
