...
\textbf{Instead of defining an increment it is also possible to prescribe the number of grid points, where it is 
expected that this value is larger than 5.0.}
...
\begin{tabbing}
  ...
  %
  \\[0.5em]
  global grid with 720x360 grid points: \>
