...
use\_exch\_barrier &
L & .FALSE.& &
if .TRUE., set an MPI barrier at the beginning of each MPI exchange call (do not use for production runs!)&
\tabularnewline
...
Sequence of send/receive calls: \\
 ...
 2 = isend/recv  \\
 3 = isend/irecv \\
 4 = irecv/send with message size blocking  &
\tabularnewline

\hline 
exch\_msgsize &
I & 8192 & &
Blocking size of exchange messages & iorder\_sendrecv = 4
\tabularnewline
...
itype\_pres\_msl&
I& 1. & &
Specifies method for computation of mean sea level pressure. \\
