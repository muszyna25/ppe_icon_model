...
\begin{longtable}{|>{\raggedright}p{5.5cm}|>{\raggedright}p{0.8cm}|>{\raggedright}p{3.2cm}|>{\raggedright}p{1cm}|>{\raggedright}p{5cm}|>{\raggedright}p{3.5cm}|}
\hline
Parameter&
Type&
Default&
...
%-------------------------------------------------------------------
% master_ctl: the minimum one needs to specify about an integration
%-------------------------------------------------------------------
\subsection{master\_ctl}
...
'restart.info'&
&
Name (including full path) of the restart info file for the ocean model &
\tabularnewline
...
'NAMELIST\_ICON'&
&
Name (including full path) of the atmosphere-specific namelist file &
\tabularnewline
...
'NAMELIST\_ICON'&
&
Name (including full path) of the ocean-specific namelist file &
\tabularnewline
...
1.0 &
&
minimum value of hdiff\_efdt\_ratio near model top & iequations=3 .AND. i\_cell\_type=3
\tabularnewline
\hline 
hdiff\_tv\_ratio&
R&
