...
& & 6& & 0: no horiz. transport & \tabularnewline
...
& & & & 5: FFSL\_HYB (hybrid FFSL/MIURA3 scheme) & lsq\_high\_ord $\in$ [2,3] \tabularnewline
...
& & & & 52: combination of FFSL\_HYB and miura with subcycling& if cell\_type=3 \tabularnewline
...
& & & & 3: gradient based on 3-node triangular element (derivative of linear shape functions)&
\tabularnewline
