...
divdamp\_order&
I& 4& &
Order/type of divergence damping: \\ 
2 = second-order damping acting on 2D divergence \\
3 = second-order damping acting on 3D divergence \\
4 = fourth-order damping acting on 2D divergence \\
5 = fourth-order damping acting on 3D divergence&
lhdiff\_rcf = .TRUE.
\tabularnewline
