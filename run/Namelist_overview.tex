...
ntasks\_per\_node &
I & 0 & &
Assumption about number of MPI tasks per node used for geographical reordering of owner IDs in order to 
reduce inter-node communication (0 means that the reordering is turned off) &
division\_method = 1
\tabularnewline
