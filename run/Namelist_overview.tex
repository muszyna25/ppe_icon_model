...
\begin{longtable}{|>{\raggedright}p{5.5cm}|>{\raggedright}p{2cm}|>{\raggedright}p{3.2cm}|>{\raggedright}p{1cm}|>{\raggedright}p{5cm}|>{\raggedright}p{3.5cm}|}
\hline
Parameter&
Type& Default& Unit&
Description & Scope
...
Initial date and time of the simulaiton. 
\tabularnewline

\hline 
end\_datatime\_string &
C & 2008-09-01T01:40:00Z' &&
End date and time of the simulaiton. 
\tabularnewline
...
and negative indices for the ocean.\\
