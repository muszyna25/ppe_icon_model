...
''\texttt{<path>prepiconR<nroot>B<jlev>\_<timestamp>}.nc''. Optional
keyword \texttt{<path>} will be substituted by
\texttt{latbc\_path}. \texttt{<timestamp>} will be automatically
replaced in the run-time.
&
itype\_latbc $\ge$ 1
\tabularnewline
