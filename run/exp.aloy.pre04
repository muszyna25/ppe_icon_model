...
# in ISO-format for ICON-model
#  - increasing dtime_oce during a run (up to 30 minutes tested)
mts_atm="PT10M"
mts_oce="PT10M"

# in seconds for YAC - must match those of the model
...
# ocean timestep increased to 30 minutes - icon and yac
#mts_oce="PT30M"
# change timestep of ocean/coupled to multiple of atm. timestep
# dtime_oce must be multiple of dtime_atm
