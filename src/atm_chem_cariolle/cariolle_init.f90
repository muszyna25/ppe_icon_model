...
pvi%a1(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
CALL read_3d_var(file_id, 'a2',nmonthx,nlevx,nlatx,a_3d)
pvi%a2(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
CALL read_3d_var(file_id, 'a3',nmonthx,nlevx,nlatx,a_3d)
pvi%a3(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
CALL read_3d_var(file_id, 'a4',nmonthx,nlevx,nlatx,a_3d)
pvi%a4(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
CALL read_3d_var(file_id, 'a5',nmonthx,nlevx,nlatx,a_3d)
pvi%a5(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
CALL read_3d_var(file_id, 'a6',nmonthx,nlevx,nlatx,a_3d)
pvi%a6(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
CALL read_3d_var(file_id, 'a7',nmonthx,nlevx,nlatx,a_3d)
pvi%a7(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
CALL read_3d_var(file_id, 'a8',nmonthx,nlevx,nlatx,a_3d)
pvi%a8(1:nlatx,:,:)=RESHAPE(a_3d,(/nlatx,nlevx,nmonthx/),ORDER=(/3,2,1/))
