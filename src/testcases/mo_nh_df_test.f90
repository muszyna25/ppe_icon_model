...
MODULE mo_nh_df_test
  ...
  USE mo_advection_utils,     ONLY: ctracer_list, ihadv_tracer, itype_hlimit, &
...
!    &   u1 = 2.4_wp, u2 = 2.0_wp, u3 = 1._wp !< original values
  ...
  PUBLIC :: init_nh_state_prog_dftest, get_nh_df_velocity, get_nh_df_mflx_rho, &
...
!$OMP END PARALLEL
  ...
  SUBROUTINE get_nh_df_mflx_rho( p_patch, p_int, p_prog_now, p_prog_new, &
    ...
    ! explicit (re)-integration of mass continuity equation.
