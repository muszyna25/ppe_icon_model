...
CONTAINS
  ...
  ! &   KBOTSC,   LDSC                       &
    ...
    INTEGER(KIND=jpim),PARAMETER :: ktrac = 0
    !<KF
...
!    INTEGER(KIND=jpim)               :: kstart ! Argument NOT used
    ...
    !>KF
    !REAL(KIND=JPRB)  ,INTENT(IN)    :: PSSTRU(KLON) ! Argument NOT used
    !REAL(KIND=JPRB)  ,INTENT(IN)    :: PSSTRV(KLON) ! Argument NOT used
    !<
...
!CDIR END
    ...
    !                  ---------------------------------------
    !KF 2010-0707
    !removed PSSTRU/PSSTRV from argumentlist of cubasen, since
    !fields are not used
    !
    CALL cubasen &
      & ( kidia,    kfdia,    klon,   1,    klev,&
