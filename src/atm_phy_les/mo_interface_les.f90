...
!$OMP PARALLEL
!$OMP DO PRIVATE(jb,jk,jc,jt,i_startidx,i_endidx,zqcn,zqin) ICON_OMP_DEFAULT_SCHEDULE
    DO jb = i_startblk, i_endblk
        CALL get_indices_c(pt_patch, jb, i_startblk, i_endblk, &
                           i_startidx, i_endidx, rl_start, rl_end)
...
!Clipping tracers
      DO jk = kstart_moist(jg), nlev
        DO jc = i_startidx, i_endidx
          ...
          zqcn = MIN(0._wp, pt_prog_rcf%tracer(jc,jk,jb,iqc))
          zqin = MIN(0._wp, pt_prog_rcf%tracer(jc,jk,jb,iqi))
