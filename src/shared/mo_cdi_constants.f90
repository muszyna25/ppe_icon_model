MODULE mo_cdi_constants
  ...
  INTEGER, PARAMETER, PUBLIC      :: ZA_SNOW                = 10
  INTEGER, PARAMETER, PUBLIC      :: ZA_SNOW_HALF           = 11
  ...
  INTEGER, PARAMETER, PUBLIC      :: ZA_DEPTH_RUNOFF_S      = 23
  INTEGER, PARAMETER, PUBLIC      :: ZA_DEPTH_RUNOFF_G      = 24
  ! Ocean
  INTEGER, PARAMETER, PUBLIC      :: ZA_DEPTH_BELOW_SEA     = 25
  INTEGER, PARAMETER, PUBLIC      :: ZA_DEPTH_BELOW_SEA_HALF= 26
  INTEGER, PARAMETER, PUBLIC      :: ZA_GENERIC_ICE         = 27
