...
MODULE mo_echam_conv_constants
  ...
  REAL(wp),PARAMETER :: entrscv  = 3.0E-3_wp !< average entrainment rate for shallow convection
  ...
  REAL(wp),PARAMETER :: cprcon   = 2.5E-4_wp !< coefficient for determining conversion
                                             !< from cloud water to rain
  REAL(wp),PARAMETER :: cmfctop  = 0.2_wp    !< fractional convective mass flux across the top of cloud
  ...
  REAL(wp),PARAMETER :: cminbuoy = 0.2_wp    !< minimum excess buoyancy
