...
MODULE mo_interface_echam_gw_hines
  ...
  IMPLICIT NONE
  PRIVATE
  PUBLIC :: interface_echam_gw_hines

CONTAINS

  SUBROUTINE interface_echam_gw_hines(patch, rl_start, rl_end, field, tend, zconv, zq_phy)
...
!$OMP END PARALLEL DO 
  ...
  END SUBROUTINE interface_echam_gw_hines
   !-------------------------------------------------------------------
...
END MODULE mo_interface_echam_gw_hines
