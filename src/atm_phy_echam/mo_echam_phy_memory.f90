...
!0!    INTEGER :: shape4d(4)
    ...
    grib2_desc = grib2_var(0,20,103, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    grib2_desc = grib2_var(0,20,104, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    cf_desc    = t_cf_var('condensated_water', 'kg kg-1', 'cloud water + cloud ice', &
         &                DATATYPE_FLT32)
    grib2_desc = grib2_var(0,1,21, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    grib2_desc = grib2_var(0,4,255, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    grib2_desc = grib2_var(0,0,17, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    CALL add_var( field_list, prefix//'ts_icecl', field%Tsurf ,               &
      ...
      &          grib2_var(10,2,8, ibits, GRID_REFERENCE, GRID_CELL),       &
      &          ldims=shapeice)
    ...
    CALL add_var( field_list, prefix//'hs_icecl', field%hs ,                  &
      ...
      &          grib2_var(10,2,255, ibits, GRID_REFERENCE, GRID_CELL),&
      &          ldims=shapeice, lrestart=.TRUE.)
    ...
    grib2_desc = grib2_var(0,5,6, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    grib2_desc = grib2_var(0,6,28, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    grib2_desc = grib2_var(0,19,255, ibits, GRID_REFERENCE, GRID_CELL)
    ...
    !--------------------
     ...
     !ALLOCATE( field% coriol (nproma,nblks),                &
      ...
      grib2_desc = grib2_var(10,1,2, iextbits, GRID_REFERENCE, GRID_CELL)
      ...
      grib2_desc = grib2_var(10,1,3, iextbits, GRID_REFERENCE, GRID_CELL)
  ...
  !         & field% lfglac (kproma, kblks)  ) 
    ...
    CALL add_var( field_list, prefix//'evspsbl_tile', field%evap_tile,    &
                ...
                & grib2_var(0,1,6, ibits, GRID_REFERENCE, GRID_CELL),     &
                & ldims=shapesfc, lmiss=.TRUE., missval=cdimissval,       &
                & lcontainer=.TRUE., lrestart=.FALSE., loutput=.FALSE.    )
