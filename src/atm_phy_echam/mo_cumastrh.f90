!>
!! Module contains subroutine cumastrh -- master routine
...
!!$           pxtecnl(kbdim,klev),     pxtecni(kbdim,klev),                &
           zmfull(kbdim,klev),      zmfuli(kbdim,klev),zhelp(kbdim)
...
!                  ----------------------------------------------
!
  CALL cuasct(lmfdudv, lmfmid, dlev, cmfctop, cprcon, cminbuoy,nmctop, &
