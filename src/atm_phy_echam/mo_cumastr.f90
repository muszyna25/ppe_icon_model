...
MODULE mo_cumastr
  ...
  USE mo_echam_conv_params,   ONLY: lmfdd, lmfdudv,                  &
...
CONTAINS
  !>
  !!
  SUBROUTINE cumastr(  pdtime, ptime_step_len,                            &
...
!
  icuasc=1
!
  CALL cuasc(pdtime, ptime_step_len,                                   &
...
!
!800 CONTINUE
  CALL cudtdq(pdtime, kproma, kbdim, klev, klevp1, itopm2, ldcum, ktrac, &
