...
MODULE mo_ocean_physics
  ...
  USE mo_ocean_nml,           ONLY: &
    ...
    & use_wind_mixing,                                        &
    & vert_mix_type, vmix_pp, vmix_tke,                       & ! by_nils
...
!<Optimize:inUse:done>
  SUBROUTINE update_ho_params(patch_3d, ocean_state, fu10, concsum, params_oce,op_coeffs, &
    &  atmos_fluxes) !, calculate_density_func)
