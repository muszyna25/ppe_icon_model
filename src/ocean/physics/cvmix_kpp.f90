...
! !INTERFACE:
  ...
  subroutine cvmix_coeffs_kpp_low(Mdiff_out, Tdiff_out, Sdiff_out, zw, zt,    &
                                  ...
                                  langmuir_Efactor, CVmix_kpp_params_user,w_m,w_s)
...
!    real(cvmix_r8), dimension(nlev+1) :: sigma, w_m, w_s
    real(cvmix_r8), dimension(nlev+1) :: sigma
    real(cvmix_r8), dimension(nlev+1),intent(inout) :: w_m, w_s
