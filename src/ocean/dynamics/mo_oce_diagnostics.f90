...
TYPE t_oce_monitor
    ...
    REAL(wp) :: forc_fw_ice_impl ! implied surface freshwater flux due to changes in sea ice [m/s]
    REAL(wp) :: forc_fw_ice_vol  ! surface freshwater volume flux due to changes in sea ice  [m/s]
