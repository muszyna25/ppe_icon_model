...
!$OMP END PARALLEL
  ...
  !!
  SUBROUTINE test_solve_nh (p_nh, p_patch, p_int, bufr, nnow, nnew, l_init, l_recompute, &
...
!!$OMP END PARALLEL
  ...
  END SUBROUTINE test_solve_nh

END MODULE mo_test_solve_nonhydro
