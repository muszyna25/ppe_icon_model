...
#include "grid_definitions.inc"
  ...
  USE mo_grid_toolbox , ONLY : get_basic_dual_grid, inverse_connectivity_verts
  IMPLICIT NONE
...
!    verts => in_grid%verts
    ...
    DO cell_no=1,no_of_cells
     ...
     !     print *, "max/min dual", max_dual_edge, min_dual_edge
      ...
      centers_diff = arc_length(cells%cartesian_center(cell_no), barycenters(cell_no)) * re
...
!         max_centers_diff_ratio
    ...
    write(0,*) 'Max barycenter-center distance:', max_centers_diff * re
