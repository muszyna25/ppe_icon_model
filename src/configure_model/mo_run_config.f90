...
MODULE mo_run_config
  ...
  PUBLIC :: iTRSF6_l,iTRSF6_r,iTRSF6_d            !Running index for chemical tracer in ICON-ART - SF6
  ...
  CHARACTER(len=*),PARAMETER,PRIVATE :: version = '$Id$'
    ...
    INTEGER :: iTRSF6_l        !< chemical tracer in ICON-ART
    INTEGER :: iTRSF6_r        !< chemical tracer in ICON-ART
    INTEGER :: iTRSF6_d        !< chemical tracer in ICON-ART
