...
MODULE mo_psrad_srtm_setup
  ...
  PUBLIC :: ngb, ngc, ngs, nsp, ioff, mult,           &
       &    lay_ref, lay_sref_mask,                   &
       &    ssi_default, ssi_amip,                    &
       &    ssi_cmip5_picontrol, ssi_cmip6_picontrol, &
       &    ssi_RCEdiurnOn, ssi_RCEdiurnOff,          &
       &    ssi_radt, tsi_radt, tsi,                  &
  ...
  ! Spectral solar irradiances in W/m2 at 1 AU distance form the sun
  ! in nbndsw SW bands of the SRTM scheme
  REAL(wp), PARAMETER :: &
       !
