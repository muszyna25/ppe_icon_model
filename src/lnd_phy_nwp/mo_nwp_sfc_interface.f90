...
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,1,:,:))",MAXVAL(lnd_prog_now%t_so(:,1,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,1,:,:))",MINVAL(lnd_prog_now%t_so(:,1,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,1,:,:))",MAXVAL(lnd_prog_new%t_so(:,1,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,1,:,:))",MINVAL(lnd_prog_new%t_so(:,1,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,2,:,:))",MAXVAL(lnd_prog_now%t_so(:,2,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,2,:,:))",MINVAL(lnd_prog_now%t_so(:,2,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,2,:,:))",MAXVAL(lnd_prog_new%t_so(:,2,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,2,:,:))",MINVAL(lnd_prog_new%t_so(:,2,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,3,:,:))",MAXVAL(lnd_prog_now%t_so(:,3,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,3,:,:))",MINVAL(lnd_prog_now%t_so(:,3,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,3,:,:))",MAXVAL(lnd_prog_new%t_so(:,3,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,3,:,:))",MINVAL(lnd_prog_new%t_so(:,3,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,4,:,:))",MAXVAL(lnd_prog_now%t_so(:,4,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,4,:,:))",MINVAL(lnd_prog_now%t_so(:,4,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,4,:,:))",MAXVAL(lnd_prog_new%t_so(:,4,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,4,:,:))",MINVAL(lnd_prog_new%t_so(:,4,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,5,:,:))",MAXVAL(lnd_prog_now%t_so(:,5,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,5,:,:))",MINVAL(lnd_prog_now%t_so(:,5,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,5,:,:))",MAXVAL(lnd_prog_new%t_so(:,5,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,5,:,:))",MINVAL(lnd_prog_new%t_so(:,5,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,6,:,:))",MAXVAL(lnd_prog_now%t_so(:,6,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,6,:,:))",MINVAL(lnd_prog_now%t_so(:,6,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,6,:,:))",MAXVAL(lnd_prog_new%t_so(:,6,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,6,:,:))",MINVAL(lnd_prog_new%t_so(:,6,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,7,:,:))",MAXVAL(lnd_prog_now%t_so(:,7,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,7,:,:))",MINVAL(lnd_prog_now%t_so(:,7,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,7,:,:))",MAXVAL(lnd_prog_new%t_so(:,7,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,7,:,:))",MINVAL(lnd_prog_new%t_so(:,7,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,8,:,:))",MAXVAL(lnd_prog_now%t_so(:,8,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,8,:,:))",MINVAL(lnd_prog_now%t_so(:,8,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,8,:,:))",MAXVAL(lnd_prog_new%t_so(:,8,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,8,:,:))",MINVAL(lnd_prog_new%t_so(:,8,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_so(:,9,:,:))",MAXVAL(lnd_prog_now%t_so(:,9,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_so(:,9,:,:))",MINVAL(lnd_prog_now%t_so(:,9,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_so(:,9,:,:))",MAXVAL(lnd_prog_new%t_so(:,9,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_so(:,9,:,:))",MINVAL(lnd_prog_new%t_so(:,9,:,:))
write(0,*)
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,1,:,:))",MAXVAL(lnd_prog_now%w_so(:,1,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,1,:,:))",MINVAL(lnd_prog_now%w_so(:,1,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,1,:,:))",MAXVAL(lnd_prog_new%w_so(:,1,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,1,:,:))",MINVAL(lnd_prog_new%w_so(:,1,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,2,:,:))",MAXVAL(lnd_prog_now%w_so(:,2,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,2,:,:))",MINVAL(lnd_prog_now%w_so(:,2,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,2,:,:))",MAXVAL(lnd_prog_new%w_so(:,2,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,2,:,:))",MINVAL(lnd_prog_new%w_so(:,2,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,3,:,:))",MAXVAL(lnd_prog_now%w_so(:,3,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,3,:,:))",MINVAL(lnd_prog_now%w_so(:,3,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,3,:,:))",MAXVAL(lnd_prog_new%w_so(:,3,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,3,:,:))",MINVAL(lnd_prog_new%w_so(:,3,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,4,:,:))",MAXVAL(lnd_prog_now%w_so(:,4,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,4,:,:))",MINVAL(lnd_prog_now%w_so(:,4,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,4,:,:))",MAXVAL(lnd_prog_new%w_so(:,4,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,4,:,:))",MINVAL(lnd_prog_new%w_so(:,4,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,5,:,:))",MAXVAL(lnd_prog_now%w_so(:,5,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,5,:,:))",MINVAL(lnd_prog_now%w_so(:,5,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,5,:,:))",MAXVAL(lnd_prog_new%w_so(:,5,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,5,:,:))",MINVAL(lnd_prog_new%w_so(:,5,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,6,:,:))",MAXVAL(lnd_prog_now%w_so(:,6,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,6,:,:))",MINVAL(lnd_prog_now%w_so(:,6,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,6,:,:))",MAXVAL(lnd_prog_new%w_so(:,6,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,6,:,:))",MINVAL(lnd_prog_new%w_so(:,6,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,7,:,:))",MAXVAL(lnd_prog_now%w_so(:,7,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,7,:,:))",MINVAL(lnd_prog_now%w_so(:,7,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,7,:,:))",MAXVAL(lnd_prog_new%w_so(:,7,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,7,:,:))",MINVAL(lnd_prog_new%w_so(:,7,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%w_so(:,8,:,:))",MAXVAL(lnd_prog_now%w_so(:,8,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%w_so(:,8,:,:))",MINVAL(lnd_prog_now%w_so(:,8,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%w_so(:,8,:,:))",MAXVAL(lnd_prog_new%w_so(:,8,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%w_so(:,8,:,:))",MINVAL(lnd_prog_new%w_so(:,8,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_gt(:,:,:))",MAXVAL(lnd_prog_now%t_gt(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_gt(:,:,:))",MINVAL(lnd_prog_now%t_gt(:,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_gt(:,:,:))",MAXVAL(lnd_prog_new%t_gt(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_gt(:,:,:))",MINVAL(lnd_prog_new%t_gt(:,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_s(:,:,:))",MAXVAL(lnd_prog_now%t_s(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_s(:,:,:))",MINVAL(lnd_prog_now%t_s(:,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_s(:,:,:))",MAXVAL(lnd_prog_new%t_s(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_s(:,:,:))",MINVAL(lnd_prog_new%t_s(:,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%t_snow(:,:,:))",MAXVAL(lnd_prog_now%t_snow(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%t_snow(:,:,:))",MINVAL(lnd_prog_now%t_snow(:,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%t_snow(:,:,:))",MAXVAL(lnd_prog_new%t_snow(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%t_snow(:,:,:))",MINVAL(lnd_prog_new%t_snow(:,:,:))
write(0,*)
write(0,*) "vor MAXVAL(lnd_prog_now%rho_snow(:,:,:))",MAXVAL(lnd_prog_now%rho_snow(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_now%rho_snow(:,:,:))",MINVAL(lnd_prog_now%rho_snow(:,:,:))
write(0,*) "vor MAXVAL(lnd_prog_new%rho_snow(:,:,:))",MAXVAL(lnd_prog_new%rho_snow(:,:,:))
write(0,*) "vor MINVAL(lnd_prog_new%rho_snow(:,:,:))",MINVAL(lnd_prog_new%rho_snow(:,:,:))
...
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,1,:,:))",MAXVAL(lnd_prog_now%t_so(:,1,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,1,:,:))",MINVAL(lnd_prog_now%t_so(:,1,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,1,:,:))",MAXVAL(lnd_prog_new%t_so(:,1,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,1,:,:))",MINVAL(lnd_prog_new%t_so(:,1,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,2,:,:))",MAXVAL(lnd_prog_now%t_so(:,2,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,2,:,:))",MINVAL(lnd_prog_now%t_so(:,2,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,2,:,:))",MAXVAL(lnd_prog_new%t_so(:,2,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,2,:,:))",MINVAL(lnd_prog_new%t_so(:,2,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,3,:,:))",MAXVAL(lnd_prog_now%t_so(:,3,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,3,:,:))",MINVAL(lnd_prog_now%t_so(:,3,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,3,:,:))",MAXVAL(lnd_prog_new%t_so(:,3,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,3,:,:))",MINVAL(lnd_prog_new%t_so(:,3,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,4,:,:))",MAXVAL(lnd_prog_now%t_so(:,4,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,4,:,:))",MINVAL(lnd_prog_now%t_so(:,4,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,4,:,:))",MAXVAL(lnd_prog_new%t_so(:,4,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,4,:,:))",MINVAL(lnd_prog_new%t_so(:,4,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,5,:,:))",MAXVAL(lnd_prog_now%t_so(:,5,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,5,:,:))",MINVAL(lnd_prog_now%t_so(:,5,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,5,:,:))",MAXVAL(lnd_prog_new%t_so(:,5,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,5,:,:))",MINVAL(lnd_prog_new%t_so(:,5,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,6,:,:))",MAXVAL(lnd_prog_now%t_so(:,6,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,6,:,:))",MINVAL(lnd_prog_now%t_so(:,6,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,6,:,:))",MAXVAL(lnd_prog_new%t_so(:,6,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,6,:,:))",MINVAL(lnd_prog_new%t_so(:,6,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,7,:,:))",MAXVAL(lnd_prog_now%t_so(:,7,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,7,:,:))",MINVAL(lnd_prog_now%t_so(:,7,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,7,:,:))",MAXVAL(lnd_prog_new%t_so(:,7,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,7,:,:))",MINVAL(lnd_prog_new%t_so(:,7,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,8,:,:))",MAXVAL(lnd_prog_now%t_so(:,8,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,8,:,:))",MINVAL(lnd_prog_now%t_so(:,8,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,8,:,:))",MAXVAL(lnd_prog_new%t_so(:,8,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,8,:,:))",MINVAL(lnd_prog_new%t_so(:,8,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_so(:,9,:,:))",MAXVAL(lnd_prog_now%t_so(:,9,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_so(:,9,:,:))",MINVAL(lnd_prog_now%t_so(:,9,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_so(:,9,:,:))",MAXVAL(lnd_prog_new%t_so(:,9,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_so(:,9,:,:))",MINVAL(lnd_prog_new%t_so(:,9,:,:))
write(0,*)
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,1,:,:))",MAXVAL(lnd_prog_now%w_so(:,1,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,1,:,:))",MINVAL(lnd_prog_now%w_so(:,1,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,1,:,:))",MAXVAL(lnd_prog_new%w_so(:,1,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,1,:,:))",MINVAL(lnd_prog_new%w_so(:,1,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,2,:,:))",MAXVAL(lnd_prog_now%w_so(:,2,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,2,:,:))",MINVAL(lnd_prog_now%w_so(:,2,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,2,:,:))",MAXVAL(lnd_prog_new%w_so(:,2,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,2,:,:))",MINVAL(lnd_prog_new%w_so(:,2,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,3,:,:))",MAXVAL(lnd_prog_now%w_so(:,3,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,3,:,:))",MINVAL(lnd_prog_now%w_so(:,3,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,3,:,:))",MAXVAL(lnd_prog_new%w_so(:,3,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,3,:,:))",MINVAL(lnd_prog_new%w_so(:,3,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,4,:,:))",MAXVAL(lnd_prog_now%w_so(:,4,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,4,:,:))",MINVAL(lnd_prog_now%w_so(:,4,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,4,:,:))",MAXVAL(lnd_prog_new%w_so(:,4,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,4,:,:))",MINVAL(lnd_prog_new%w_so(:,4,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,5,:,:))",MAXVAL(lnd_prog_now%w_so(:,5,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,5,:,:))",MINVAL(lnd_prog_now%w_so(:,5,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,5,:,:))",MAXVAL(lnd_prog_new%w_so(:,5,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,5,:,:))",MINVAL(lnd_prog_new%w_so(:,5,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,6,:,:))",MAXVAL(lnd_prog_now%w_so(:,6,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,6,:,:))",MINVAL(lnd_prog_now%w_so(:,6,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,6,:,:))",MAXVAL(lnd_prog_new%w_so(:,6,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,6,:,:))",MINVAL(lnd_prog_new%w_so(:,6,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,7,:,:))",MAXVAL(lnd_prog_now%w_so(:,7,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,7,:,:))",MINVAL(lnd_prog_now%w_so(:,7,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,7,:,:))",MAXVAL(lnd_prog_new%w_so(:,7,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,7,:,:))",MINVAL(lnd_prog_new%w_so(:,7,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%w_so(:,8,:,:))",MAXVAL(lnd_prog_now%w_so(:,8,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%w_so(:,8,:,:))",MINVAL(lnd_prog_now%w_so(:,8,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%w_so(:,8,:,:))",MAXVAL(lnd_prog_new%w_so(:,8,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%w_so(:,8,:,:))",MINVAL(lnd_prog_new%w_so(:,8,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_gt(:,:,:))",MAXVAL(lnd_prog_now%t_gt(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_gt(:,:,:))",MINVAL(lnd_prog_now%t_gt(:,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_gt(:,:,:))",MAXVAL(lnd_prog_new%t_gt(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_gt(:,:,:))",MINVAL(lnd_prog_new%t_gt(:,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_s(:,:,:))",MAXVAL(lnd_prog_now%t_s(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_s(:,:,:))",MINVAL(lnd_prog_now%t_s(:,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_s(:,:,:))",MAXVAL(lnd_prog_new%t_s(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_s(:,:,:))",MINVAL(lnd_prog_new%t_s(:,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%t_snow(:,:,:))",MAXVAL(lnd_prog_now%t_snow(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%t_snow(:,:,:))",MINVAL(lnd_prog_now%t_snow(:,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%t_snow(:,:,:))",MAXVAL(lnd_prog_new%t_snow(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%t_snow(:,:,:))",MINVAL(lnd_prog_new%t_snow(:,:,:))
write(0,*)
write(0,*) "nach MAXVAL(lnd_prog_now%rho_snow(:,:,:))",MAXVAL(lnd_prog_now%rho_snow(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_now%rho_snow(:,:,:))",MINVAL(lnd_prog_now%rho_snow(:,:,:))
write(0,*) "nach MAXVAL(lnd_prog_new%rho_snow(:,:,:))",MAXVAL(lnd_prog_new%rho_snow(:,:,:))
write(0,*) "nach MINVAL(lnd_prog_new%rho_snow(:,:,:))",MINVAL(lnd_prog_new%rho_snow(:,:,:))
