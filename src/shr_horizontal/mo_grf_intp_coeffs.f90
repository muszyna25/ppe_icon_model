 ...
 CD_LOOP: DO jcd = 1, p_patch(jg)%n_childdom
  ...
  DO jb = i_startblk, i_endblk
    ...
    DO je = i_startidx, i_endidx
      ...
      p_grfs%grf_dist_pe2ce(je,1,jb) = re*p_ep%system_orientation(je,jb)* &
      ...
      p_grfs%grf_dist_pe2ce(je,2,jb) = re*p_ep%system_orientation(je,jb)* &
