\begin{versionhistory}
  ...
  \vhEntry{0.3.1}{24.01.14}{DR   }{Added information about newly available output field $\omega$}
  \vhEntry{0.4.0}{22.05.14}{HF   }{Added SKY-database documentation}
  \vhEntry{0.4.1}{15.07.14}{DR   }{Some documentation on statistical processing and minor updates}
\end{versionhistory}