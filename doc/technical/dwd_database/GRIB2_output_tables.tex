...
to $78\,\mathrm{h}$. Additional short forecasts are performed at 3, 9, 15 and 21UTC, in order to provide boundary data for the high 
resolution COSMO-DE runs. The forecast time covered by these runs is limited to $30\,\mathrm{h}$.

All time-dependent output fields are available hourly up to $VV=78\,\mathrm{h}$ and 3-hourly for 
larger forecast times\footnotemark[2].
