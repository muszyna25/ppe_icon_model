...
%\begin{description}[font=\sffamily\bfseries, leftmargin=3.0cm,style=sameline]
\begin{description}[leftmargin=3.0cm,style=sameline]
  \item [HBAS\_CON] Height of the convective cloud base in m above msl. $\mathrm{HBAS\_CON}$ is initialized with $-500\,\mathrm{m}$ at points where no convection is diagnosed.
