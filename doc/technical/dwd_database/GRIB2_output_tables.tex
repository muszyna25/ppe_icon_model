...
\begin{itemize}
 \item \textbf{W} $[m/s]$: vertical velocity in height coordinates $w=\frac{\mathrm{d}z}{\mathrm{d}t}$ (3D field)
 \item \textbf{DEN} $[kg/m^{3}]$: density of moist air (3D field)
 \item \textbf{HSURF} $[\mathrm{m}]$: Geometric Height of the earths surface above sea level (2D field)
 \item \textbf{HHL} $[\mathrm{m}]$: Geometric Height of model half levels above sea level (3D field)
 \item \textbf{CLON,CLAT} $[\mathrm{deg}]$: Geographical longitude/latitude of native grid triangle cell center
 \item \textbf{ELON,ELAT} $[\mathrm{deg}]$: Geographical longitude/latitude of native grid triangle edge midpoint 
 \item \textbf{VLON,VLAT} $[\mathrm{deg}]$: Geographical longitude/latitude of native grid triangle vertex
\end{itemize}
...
\caption{Hybrid multi-level forecast ($VV>0$) and initialised analysis ($VV=0$) products}
 \begin{tabular}{p{2.0cm}p{5.0cm}p{0.7cm}p{0.7cm}p{0.7cm}p{1.4cm}p{1cm}p{1cm}}
  \toprule
\multicolumn{1}{c}{\begin{sideways}\textbf{ShortName}\end{sideways}}  &  \multicolumn{1}{c}{\rb{\textbf{Description}}}  & \begin{sideways}\textbf{Discipline}\end{sideways} & \begin{sideways}\bf{Category}\end{sideways} & \begin{sideways}\bf{Number}\end{sideways}  & \begin{sideways}\bf{Lev-Typ 1/2\footnotemark[1] }\end{sideways}  & \begin{sideways}\bf{stepType}\end{sideways} &\begin{sideways}\bf{Unit}\end{sideways}\\
\midrule
...
QC                         &  \textcolor{red}{Cloud mixing ratio}\footnotemark[2]                                       &               0                                   &                     1                       &                    22                      &                 105/105                         &                      inst                   &        $\mathrm{kg\,kg^{-1}}$ \\
QI                         &  \textcolor{red}{Cloud ice mixing ratio}\footnotemark[2]                                   &               0                                   &                     1                       &                    82                      &                 105/105                         &                      inst                   &        $\mathrm{kg\,kg^{-1}}$ \\
QR                         &  \textcolor{red}{Rain mixing ratio}\footnotemark[2]                                        &               0                                   &                     1                       &                    24                      &                 105/105                         &                      inst                   &        $\mathrm{kg\,kg^{-1}}$ \\
QS                         &  \textcolor{red}{Snow mixing ratio}\footnotemark[2]                                        &               0                                   &                     1                       &                    25                      &                 105/105                         &                      inst                   &        $\mathrm{kg\,kg^{-1}}$ \\
CLC                        &  Cloud cover                                                                               &               0                                   &                     6                       &                    22                      &                 105/105                         &                      inst                   &        $\mathrm{\%}$ \\
\textcolor{gray}{O3}       &  \textcolor{gray}{Ozone mixing ratio}\footnotemark[3]                                      &               \textcolor{gray}{0}                 &        \textcolor{gray}{14}                 &      \textcolor{gray}{1}                   &     \textcolor{gray}{105/105}                   &     \textcolor{gray}{inst}                  &        \textcolor{gray}{$\mathrm{kg\,kg^{-1}}$} \\                                             
  \bottomrule
 \end{tabular}
\end{table}
\footnotetext[1]{\textcolor{red}{Levekl type $105$ (Hybrid level) will be replaced by $150$ (Generalized vertical height coordinate), once the GRIB\_API is able to cope with it}}. 
\footnotetext[2]{for the time being, erroneously encoded as mixing ratios instead of specific quantities}
\footnotetext[3]{not clear yet, whether ozone will be provided as output field}
...
\textcolor{gray}{CLCH}         &  \textcolor{gray}{High level clouds}\footnotemark[3]                                   &               \textcolor{gray}{0}                 &                     \textcolor{gray}{6}     &                    \textcolor{gray}{22}    &                 \textcolor{gray}{100/100}       &                      inst                   &        $\mathrm{\%}$          \\
\textcolor{gray}{CLCM}         &  \textcolor{gray}{Mid level clouds}\footnotemark[3]                                    &               \textcolor{gray}{0}                 &                     \textcolor{gray}{6}     &                    \textcolor{gray}{22}    &                 \textcolor{gray}{100/100}       &                      inst                   &        $\mathrm{\%}$          \\
\textcolor{gray}{CLCL}         &  \textcolor{gray}{Low level clouds}\footnotemark[3]                                    &               \textcolor{gray}{0}                 &                     \textcolor{gray}{6}     &                    \textcolor{gray}{22}    &                 \textcolor{gray}{100/1}         &                      inst                   &        $\mathrm{\%}$          \\
