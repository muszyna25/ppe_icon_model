...
\footnotemark[3]{Not yet available.}
...
\begin{description}[leftmargin=3.0cm,style=sameline]
 ...
 \item [W\_I]   Water content of interception layer, i.e.\ the amount of precipitation intercepted by vegetation canopies. The maximum 
                allowable water content is currently limited to $1.0E-6\,\mathrm{kg\,m^{-2}}$ due to numerical reasons and thus almost 
                negligible. Over water points, \texttt{W\_I} is set to 0.
\end{description}
