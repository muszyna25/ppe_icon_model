...
The vertical grid consists of a set of vertical layers. Each of these layers carries the horizontal $2D$ grid 
structure, thus forming the $3D$ structure of the grid.
The vertical coordinates have a terrain-following hybrid structure with height-based vertical coordinates.
Details for the calculation of the vertical coordinates can be found in \citet*{Wan2009}.
% (the last paragraph had been taken from the vertical grid description "icon_grid.tex")
...
\subfloat{
  ...
  \caption{Vertical levels of the ICON model (preliminary setup).
           The table of selected pressure values is based on the 1976 standard atmosphere.}
