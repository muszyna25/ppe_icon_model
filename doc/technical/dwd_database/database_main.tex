...
\begin{tikzpicture}[column 1/.style={anchor=east},
 ...
 text depth=0pt,text height=1.8ex,
 row sep=1ex,
 column sep=2em,
 #1
]
...
\foreach \x in {1,...,\endmtx}{
 ...
 \node[circle,timeline color st, inner sep=0.15pt, draw=white, fill=ballcolor, thick] 
 (vtimeline\thevtml-c-\x) at 
 ($(vtimeline\thevtml-\x-1.east)!0.5!(vtimeline\thevtml-\x-2.west)$){};
 \draw[timeline color st,thick,color=ballcolor](vtimeline\thevtml-c-\x.west)--++(-5pt,0);
 }
 \ifvtimelinetitle%
  \draw[timeline color st,thick]([yshift=\lineoffset]vtimeline\thevtml.north west)--
