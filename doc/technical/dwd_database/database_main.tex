...
\usepackage[square,sort,comma,numbers]{natbib} %--- creates bibliography; author-year with curly brackets within the text
...
% customize hyperref
\hypersetup{colorlinks, linkcolor=darkblue, urlcolor=darkred}
