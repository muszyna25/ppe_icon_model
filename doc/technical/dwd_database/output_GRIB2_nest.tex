...
\renewcommand{\pressurelevelsRegular}{???}
\renewcommand{\pressurelevelsTriangular}{???}
...
\end{minipage}
\end{center}
The output fields are listed in Table~\ref{table:nest:output_pressurelevels_triangular}.
...
\groups[tri][] & V                          &  Meridional wind                                                                           &               0                                   &                     2                       &                    3                       &                 100/--                          &                      inst                   &        $\mathrm{m\,s^{-1}}$   \\
  \bottomrule
 \end{tabular}
\label{table:nest:output_pressurelevels_triangular}%
\end{table}
