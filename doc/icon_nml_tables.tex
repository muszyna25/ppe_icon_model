...
6: start from DWD analysis with incremental analysis update. NOTE: This is an extension 
of mode $5$ (i.e.\ for surface/soil) which, at the end, will replace mode $5$. &
\tabularnewline
