...
\textbf{lssodrag} &
L& .TRUE.&&
.TRUE. for subgrid scale orographic drag& iforcing = 2
\tabularnewline
...
\textbf{ljsbach} &
L& .FALSE.&&
.TRUE. for calculating the JSBACH land surface& iforcing = 2\par {\color{red}Not implemeted yet}
\tabularnewline

%\hline
\textbf{lamip} &
L& .FALSE.&&
.TRUE. for AMIP simulations& iforcing = 2\par {\color{red}Not implemeted yet}
\tabularnewline
...
lsep\_grfinfo &
L & .FALSE.   &  &
If set to .TRUE., separate files are read in for basic grid info and parent-child connectivities.
Requires lsep\_gridref\_info = .TRUE. in the grid generator
&
\tabularnewline
...
lzaxis\_reference&
L& .TRUE. & &
FALSE: encode vertical axis as ZAXIS\_HYBRID for 3D atmospheric fields\\
TRUE: encode vertical axis as ZAXIS\_REFERENCE for 3D atmospheric fields &
GRIB2-output (ZAXIS\_HYBRID will be removed after some testing phase)
\tabularnewline
...
%\hline
\textbf{plevels} &
R(100)&  10000,\\ 20000,\\30000,\\...,\\100000& Pa &
...
R(:)&None& m &
 ...
 {\color{red} The height levels are currently taken from the array \emph{zlevels} in namelist nh\_pzlev\_nml. }
&
\tabularnewline
...
R(:)&None& hPa &
 pressure levels \\
 {\color{red} Not yet implemented.} \\
 {\color{red} The pressure levels are currently taken from the array \emph{plevels} in namelist nh\_pzlev\_nml. }
&
\tabularnewline
...
R(:)&None& K &
 isentropic levels \\
 {\color{red} Not yet implemented.} \\
 {\color{red} The isentropic levels are currently taken from array \emph{ilevels} in namelist nh\_pzlev\_nml. }
&
\tabularnewline
...
%\hline
use\_async\_prefetch &
I & 0& &
Enable this flag by setting it to integer value 1, used to enable asynchronous
prefetching of boundary data. Set along with num\_pref\_procs for limited area
run. &
itype\_latbc $\ge$ 1 
\tabularnewline 
