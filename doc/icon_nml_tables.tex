...
(dynamics\_nml:iequations = 1 or 2).
\tabularnewline
...
lprfcor &
L                &     .FALSE.      & &
using the profile values of the lowest main level instead of the mean value of the lowest layer for surface flux calculations & inwp\_turb = 1
\tabularnewline
...
limpltkediff &
L                &     .TRUE.      & &
use semi-implicit TKE diffusion & inwp\_turb = 1
\tabularnewline
...
for heat and moisture & inwp\_turb = 1 \\
\tabularnewline
...
% =============================================================================
%
\input{icon_ocean_nml_tables.tex}
%
