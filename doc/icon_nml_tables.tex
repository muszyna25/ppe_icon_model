...
qrsgana\_mode&
I & 0 & &
1: analysis increments for rain, snow and graupel are read and processed.  &
init\_mode=5
\tabularnewline
...
%\hline
cimpl &
R & $150.0$ &  & Stability parameter for the computation of the skin temperature \\
The default value works well for model domains with 2.2 km mesh size. For coarser grids and longer timesteps,
lower values are appropriate. \\
Reasonable range: 4.0 -- 200.0 &
\tabularnewline
