...
0: set to zero (or epsilon) \\
1: from tracer \\
2: 3-dim concentration, climatological annual cycle, monthly means from an annual file \\
4: 3-dim concentration, constant in time, 1st time slice file \\
8: 3-dim concentration, time dependent, monthly means from yearly files &
echam\_phy\_config(jg)\% \newline dt\_rad > 0.000s \tabularnewline
%
echam\_rad\_config(jg)\% \newline irad\_o2 & I & 2 & &
