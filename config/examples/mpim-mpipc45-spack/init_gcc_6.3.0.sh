...
SCT_PARALLEL_HDF5_ROOT="${SW_ROOT}/libsct-develop-ybdorgu"
SCT_PARALLEL_HDF5_FCFLAGS="-I${SCT_PARALLEL_HDF5_ROOT}/include"
SCT_PARALLEL_HDF5_LDFLAGS="-L${SCT_PARALLEL_HDF5_ROOT}/lib"
SCT_PARALLEL_HDF5_LIBS='-lsct'
...
MTIME_ROOT="${SW_ROOT}/libmtime-1.0.8-wm3fygo"
...
YAC_ROOT="${SW_ROOT}/yac-1.5.2-rc-vl4pus5"
