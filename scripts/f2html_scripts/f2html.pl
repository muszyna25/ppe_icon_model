...
use vars qw($copyright $calling_dir $date $incs);
...
# add recursive directory structures below the given directories
...
find { push @dirs, $File::Find::name if (-d && $File::Find::name !~ /\.svn/) } @tmp;
...
<TABLE>
<TR>
<TD>ICON (C)</TD><TD> Max-Planck-Institut f&uuml;r Meteorologie, Hamburg </TD>
</TR>
<TR>
<TD></TD><TD>Deutscher Wetterdienst, Offenbach</TD>
</TR>
</TABLE>
