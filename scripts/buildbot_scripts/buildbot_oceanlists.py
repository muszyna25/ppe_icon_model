...
myexp      = oceanList.add_experimentByNameToAllBuilders("checksuite.ocean_internal/omip/exp.ocean_omip_ptest")
myexp      = oceanList.add_experimentByNameToAllBuilders("checksuite.ocean_internal/omip/exp.ocean_omip_short")
myexp      = oceanList.add_experimentByNameToAllBuilders("checksuite.ocean_internal/technical/exp.test_ocean_omip_technical")
