...
!
! Generated by "./bindGen.rb" from input file "../../src/cdi.h".
...
module mo_cdi
	...
	public vlistDefVarIntArrayKey
	public vlistDefVarDblArrayKey
	public vlistHasVarKey
	public vlistInqVarDblKey
	public vlistInqVarIntKey
	public vlistInqVarDblArrayKey
	public vlistInqVarIntArrayKey
...
contains
	...
	subroutine vlistDefVarIntArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues_dummy, values_vec_dummy)
		integer(c_int), value :: vlistID_dummy
		integer(c_int), value :: varID_dummy
		character(kind = c_char, len = *), intent(in) :: name_dummy
		integer(c_int), value :: nvalues_dummy
		integer(c_int), intent(in) :: values_vec_dummy(*)
		character(kind = c_char) :: name_temp(len(name_dummy) + 1)
		integer :: name_i
		interface
			subroutine lib_vlistDefVarIntArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues_dummy, values_vec_dummy) bind(c, name = 'v&
			&listDefVarIntArrayKey')
				import c_char, c_int
				integer(c_int), value :: vlistID_dummy
				integer(c_int), value :: varID_dummy
				character(kind = c_char) :: name_dummy(*)
				integer(c_int), value :: nvalues_dummy
				integer(c_int), intent(in) :: values_vec_dummy(*)
			end subroutine lib_vlistDefVarIntArrayKey
		end interface
		do name_i = 1, len(name_dummy)
		name_temp(name_i) = name_dummy(name_i:name_i)
		end do
		name_temp(len(name_dummy) + 1) = c_null_char
		call lib_vlistDefVarIntArrayKey(vlistID_dummy, varID_dummy, name_temp, nvalues_dummy, values_vec_dummy)
	end subroutine vlistDefVarIntArrayKey

	subroutine vlistDefVarDblArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues_dummy, values_vec_dummy)
		integer(c_int), value :: vlistID_dummy
		integer(c_int), value :: varID_dummy
		character(kind = c_char, len = *), intent(in) :: name_dummy
		integer(c_int), value :: nvalues_dummy
		real(c_double), intent(in) :: values_vec_dummy(*)
		character(kind = c_char) :: name_temp(len(name_dummy) + 1)
		integer :: name_i
		interface
			subroutine lib_vlistDefVarDblArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues_dummy, values_vec_dummy) bind(c, name = 'v&
			&listDefVarDblArrayKey')
				import c_char, c_double, c_int
				integer(c_int), value :: vlistID_dummy
				integer(c_int), value :: varID_dummy
				character(kind = c_char) :: name_dummy(*)
				integer(c_int), value :: nvalues_dummy
				real(c_double), intent(in) :: values_vec_dummy(*)
			end subroutine lib_vlistDefVarDblArrayKey
		end interface
		do name_i = 1, len(name_dummy)
		name_temp(name_i) = name_dummy(name_i:name_i)
		end do
		name_temp(len(name_dummy) + 1) = c_null_char
		call lib_vlistDefVarDblArrayKey(vlistID_dummy, varID_dummy, name_temp, nvalues_dummy, values_vec_dummy)
	end subroutine vlistDefVarDblArrayKey
	...
	subroutine vlistInqVarDblArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues, values_vec_dummy)
		integer(c_int), value :: vlistID_dummy
		integer(c_int), value :: varID_dummy
		character(kind = c_char, len = *), intent(in) :: name_dummy
		integer(c_int), optional, intent(inout) :: nvalues
		real(c_double), intent(inout) :: values_vec_dummy(*)
		character(kind = c_char) :: name_temp(len(name_dummy) + 1)
		integer :: name_i
		integer(c_int), target :: nvalues_temp
		type(c_ptr) :: nvalues_ptr
		interface
			subroutine lib_vlistInqVarDblArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues, values_vec_dummy) bind(c, name = 'vlistIn&
			&qVarDblArrayKey')
				import c_char, c_double, c_int, c_ptr
				integer(c_int), value :: vlistID_dummy
				integer(c_int), value :: varID_dummy
				character(kind = c_char) :: name_dummy(*)
				type(c_ptr), value :: nvalues
				real(c_double), intent(inout) :: values_vec_dummy(*)
			end subroutine lib_vlistInqVarDblArrayKey
		end interface
		do name_i = 1, len(name_dummy)
		name_temp(name_i) = name_dummy(name_i:name_i)
		end do
		name_temp(len(name_dummy) + 1) = c_null_char
		nvalues_ptr = c_null_ptr
		if(present(nvalues)) nvalues_ptr = c_loc(nvalues_temp)
		call lib_vlistInqVarDblArrayKey(vlistID_dummy, varID_dummy, name_temp, nvalues_ptr, values_vec_dummy)
		if(present(nvalues)) nvalues = nvalues_temp
	end subroutine vlistInqVarDblArrayKey

	subroutine vlistInqVarIntArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues, values_vec_dummy)
		integer(c_int), value :: vlistID_dummy
		integer(c_int), value :: varID_dummy
		character(kind = c_char, len = *), intent(in) :: name_dummy
		integer(c_int), optional, intent(inout) :: nvalues
		integer(c_int), intent(inout) :: values_vec_dummy(*)
		character(kind = c_char) :: name_temp(len(name_dummy) + 1)
		integer :: name_i
		integer(c_int), target :: nvalues_temp
		type(c_ptr) :: nvalues_ptr
		interface
			subroutine lib_vlistInqVarIntArrayKey(vlistID_dummy, varID_dummy, name_dummy, nvalues, values_vec_dummy) bind(c, name = 'vlistIn&
			&qVarIntArrayKey')
				import c_char, c_int, c_ptr
				integer(c_int), value :: vlistID_dummy
				integer(c_int), value :: varID_dummy
				...
				type(c_ptr), value :: nvalues
				integer(c_int), intent(inout) :: values_vec_dummy(*)
			end subroutine lib_vlistInqVarIntArrayKey
		end interface
		do name_i = 1, len(name_dummy)
		name_temp(name_i) = name_dummy(name_i:name_i)
		end do
		...
		nvalues_ptr = c_null_ptr
		if(present(nvalues)) nvalues_ptr = c_loc(nvalues_temp)
		call lib_vlistInqVarIntArrayKey(vlistID_dummy, varID_dummy, name_temp, nvalues_ptr, values_vec_dummy)
		if(present(nvalues)) nvalues = nvalues_temp
	end subroutine vlistInqVarIntArrayKey
